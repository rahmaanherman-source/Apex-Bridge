...
Any material loss of protected UI, navigation, identity, functionality, accessibility, responsive behavior, or truthful state is a regression. A redesign is not automatically an upgrade.
...
This is governance, not another integration product. It applies APEX-wide and is intended to be referenced from the future standalone `apex-integrated-rule` repository.
